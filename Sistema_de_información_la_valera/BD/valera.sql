...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-12-2020 a las 02:58:04
...
(12345, 'cliente', 'perez', 23243214, 'mi casa', '2020-10-02', 'ejemplo_cliente@gmail.com', 123456, '444'),
(56879, 'pepito', 'perez', 938457, 'mi casa', '2020-10-01', 'sofiafrancofg68@gmail.com', 6562341, '\r\nMTIzNA=='),
(56880, 'maria', 'avila', 13423523, 'crr 6 b 60-20', '2004-03-12', 'mariaavila@gmail.com', 52786554, '1234'),
...
(56885, 'mario', 'ghjkl', 5787654, 'ghbjnkml,', '2004-03-12', 'qwert@misena.edu.co', 623412, 'NWZjOTBhZTIxYWY5ZQ=='),
(56886, 'dgrtjykul', 'fcgjhkl', 678, 'lkjh', '2000-03-12', 'kjmn@gmail.com', 87654, 'NWZjOTBiMzUzNzgxMw==');
...
insert into `valera` (id_valera,cantidad_vales,id_cliente) 
values 
(3,5, 56882);
...
--
ALTER TABLE `cliente`
  MODIFY `id_cliente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56887;
